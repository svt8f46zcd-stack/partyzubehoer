...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Partyzubehör Buchert – Verleih in Köngernheim, Mainz & Umgebung" },
      {
        name: "description",
        content:
          "Partyzubehör, Getränke und Veranstaltungsausstattung aus einer Hand – Köngernheim, Mainz und Umgebung.",
      },
